...
- Inspecting `.mat` files with `pyfield.utilities.explore_mat`
...
tx.compute_delays(focus_mm=[0, 0, 60])  # behaves like any PyField transducer
...
[View full script on GitHub](https://github.com/EstebanRivera08/PyField/blob/main/examples/example17_import_fieldii_transducer.py)
