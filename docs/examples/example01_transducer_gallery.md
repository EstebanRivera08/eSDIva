...
Demonstrates every transducer type available in `esdiva.transducers` — from
...
[View full script on GitHub](https://github.com/EstebanRivera08/eSDIva/blob/main/examples/example01_transducer_gallery.py)
