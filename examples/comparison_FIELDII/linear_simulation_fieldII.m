...
data.tx_element_height_mm = 1.5 ;% Height of element [mm] 
...
data.tx_elevationFocus_mm = 1000 ; % Elevation focus [mm]
...
[apodization, data] = compute_apodization(data, options) ;
data.apodization = apodization ;
% Set the apodization into the transducer
element_no = (1:data.tx_N_elements)';
apo = apodization'.*ones(1,data.no_sub_x*data.no_sub_y);
