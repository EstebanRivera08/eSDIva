% domino_fieldii.m
% ---------------------------------------------------------------------------
% Build the eSDIva "Domino" probe in MATLAB Field II and save its
% mathematical-element geometry, so example 17 can import it and check the
% imported aperture matches esdiva.transducers.Domino() patch-for-patch.
%
...
no_sub_x = 1;                % lateral  subdivisions per element (eSDIva no_sub_x)
no_sub_y = 10;               % elevation subdivisions per element (eSDIva no_sub_y)

% Elevation-focused linear array: flat element face at z = 0, cylindrical
% lens curving along y — this is the Field II analogue of a eSDIva
