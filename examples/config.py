"""
Shared output configuration for all numbered SonDI examples.
...
``SONDI_SAVE_FIG=1`` overrides ``SAVE_FIG`` (used to batch-regenerate the
...
SAVE_FIG = os.environ.get("SONDI_SAVE_FIG", "0") == "1" or False
