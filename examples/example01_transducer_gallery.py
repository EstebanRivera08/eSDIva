...
Demonstrates all transducer types available in esdiva.transducers, showing
...
print("\n" + "=" * 60)
print("  eSDIva Transducer Gallery")
print("=" * 60 + "\n")
print(
    "Available transducers in esdiva.transducers:",
    esdiva.transducers.available_transducers(),
)
