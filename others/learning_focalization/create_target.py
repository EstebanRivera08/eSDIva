...
filename = r"/matrix_custometarget1"
...
x_length_mm = 55 * 0.3  # half-wavelength in mm
y_length_mm = 55 * 0.3  # half-wavelength in mm
dx = 0.3  # half-wavelength in mm
dy = 0.3  # half-wavelength in mm
...
# -------------------- custom target --------------------
print(f"Using dx ={dx:.2f} mm dy = {dy:.2f} mm wavelength")
